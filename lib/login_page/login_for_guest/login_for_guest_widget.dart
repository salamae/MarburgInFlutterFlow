...
import 'login_for_guest_model.dart';
export 'login_for_guest_model.dart';

class LoginForGuestWidget extends StatefulWidget {
  const LoginForGuestWidget({super.key});

  @override
  State<LoginForGuestWidget> createState() => _LoginForGuestWidgetState();
}

class _LoginForGuestWidgetState extends State<LoginForGuestWidget> {
  late LoginForGuestModel _model;
