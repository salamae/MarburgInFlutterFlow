                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            enableInteractiveSelection: false,
                            validator: _model
                                .regPassword1TextControllerValidator
                                .asValidator(context),
                            inputFormatters: [
                              if (!isAndroid && !isiOS)
                                TextInputFormatter.withFunction(
                        ...
                        if (_model.reg)
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              enableInteractiveSelection: false,
                              validator: _model
                                  .regPassword2TextControllerValidator
                                  .asValidator(context),
                              inputFormatters: [
                                if (!isAndroid && !isiOS)
                                  TextInputFormatter.withFunction(
                        ...
                        if (!(isWeb
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                24.0, 11.0, 24.0, 25.0),
                            child: FFButtonWidget(
                              onPressed: !((_model.regEmailTextController
                                                  .text !=
                                              '') &&
                                      (_model.regPassword1TextController
                                                  .text !=
                                              '') &&
                                      (_model.regPassword2TextController
                                                  .text !=
                                              ''))
                                  ? null
                                  : () async {
                                      GoRouter.of(context).prepareAuthEvent();
                                      if (_model.regPassword1TextController
                                              .text !=
                                          _model.regPassword2TextController
                                              .text) {
