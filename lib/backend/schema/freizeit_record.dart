...
class FreizeitRecord extends FirestoreRecord {
  FreizeitRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('freizeit');

  static Stream<FreizeitRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => FreizeitRecord.fromSnapshot(s));

  static Future<FreizeitRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => FreizeitRecord.fromSnapshot(s));

  static FreizeitRecord fromSnapshot(DocumentSnapshot snapshot) =>
      FreizeitRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static FreizeitRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      FreizeitRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'FreizeitRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is FreizeitRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createFreizeitRecordData({
  String? apiUrl,
  String? address2,
  String? websiteUrl,
...
class FreizeitRecordDocumentEquality implements Equality<FreizeitRecord> {
  const FreizeitRecordDocumentEquality();

  @override
  bool equals(FreizeitRecord? e1, FreizeitRecord? e2) {
  ...
  @override
  int hash(FreizeitRecord? e) => const ListEquality().hash([
        e?.apiUrl,
        e?.address2,
        e?.websiteUrl,
  ...
  @override
  bool isValidKey(Object? o) => o is FreizeitRecord;
}
